...
public:
    ...
    {
        TestCaseEditWidget->setWindowTitle(QCoreApplication::translate("TestCaseEditWidget", "Form", nullptr));
        QTableWidgetItem *___qtablewidgetitem = fileList->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("TestCaseEditWidget", "Input Files", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = fileList->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("TestCaseEditWidget", "Output Files", nullptr));
        inputFileLabel->setText(QCoreApplication::translate("TestCaseEditWidget", "Input File Name", nullptr));
        outputFileLabel->setText(QCoreApplication::translate("TestCaseEditWidget", "Output File Name", nullptr));
        addButton->setText(QCoreApplication::translate("TestCaseEditWidget", "&Add", nullptr));
        fullScoreLabel->setText(QCoreApplication::translate("TestCaseEditWidget", "Full Score", nullptr));
        timeLimitLabel->setText(QCoreApplication::translate("TestCaseEditWidget", "Time Limit", nullptr));
        msLabel->setText(QCoreApplication::translate("TestCaseEditWidget", "ms", nullptr));
        memoryLimitLabel->setText(QCoreApplication::translate("TestCaseEditWidget", "Memory Limit", nullptr));
        mbLabel->setText(QCoreApplication::translate("TestCaseEditWidget", "MB", nullptr));
    } // retranslateUi
