...
public:
    ...
    {
        AddTestCasesWizard->setWindowTitle(QCoreApplication::translate("AddTestCasesWizard", "Add Test Cases", nullptr));
        stepOneLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "Step I: Input the full score, time limit and memory limit for each new test case.", nullptr));
        fullScoreLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "Full Score", nullptr));
        timeLimitLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "Time Limit", nullptr));
        msLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "ms", nullptr));
        memoryLimitLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "Memory Limit", nullptr));
        mbLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "MB", nullptr));
        stepTwoLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "Step II: Input patterns for input files and output files. You can use argument <1>, <2>, etc. to represent a regular expression. Input and output files will in the same test case when their matched parts of checked expressions are identical.", nullptr));
        inputFilesPatternLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "Input Files Pattern", nullptr));
        outputFilesPatternLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "Output Files Pattern", nullptr));
        QTableWidgetItem *___qtablewidgetitem = argumentList->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("AddTestCasesWizard", "Argument", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = argumentList->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("AddTestCasesWizard", "Regular Expression", nullptr));
        addArgumentButton->setText(QString());
        deleteArgumentButton->setText(QString());
        stepThreeLabel->setText(QCoreApplication::translate("AddTestCasesWizard", "Step III: Preview the result and finish the wizard.", nullptr));
    } // retranslateUi
